...
class QuantFactorEngine:
    ...
    def momentum_return(self, months: int) -> Optional[FactorResult]:
        ...
        return FactorResult(
            ...
            value=round(ret, 2), signal=signal, weight=1.0,
    ...
    def ma_ratio_30_75(self) -> Optional[FactorResult]:
        ...
        return FactorResult(
            ...
            value=round(ratio, 4), signal=signal, weight=1.2,
    ...
    def ma_ratio_5_30(self) -> Optional[FactorResult]:
        ...
        return FactorResult(
            ...
            value=round(ratio, 4), signal=signal, weight=1.0,
    ...
    def price_to_ma200(self) -> Optional[FactorResult]:
        ...
        return FactorResult(
            ...
            value=round(pct, 2), signal=signal, weight=1.0,
    ...
    def reversal_12m_1m(self) -> Optional[FactorResult]:
        ...
        return FactorResult(
            ...
            value=round(ret_12m - ret_1m, 2), signal=signal, weight=1.2,
            description=desc,
        )
    ...
    def rsi(self, period: int = 14) -> Optional[FactorResult]:
        ...
        return FactorResult(
            ...
            value=round(rsi_val, 2), signal=signal, weight=1.0,
            description=desc,
        )
    ...
    def macd(self) -> Optional[FactorResult]:
        ...
        return FactorResult(
            ...
            value=round(hist, 4), signal=signal, weight=1.2,
            description=desc,
        )
    ...
    def bollinger_position(self, period: int = 20) -> Optional[FactorResult]:
        ...
        return FactorResult(
            ...
            value=round(pct_b, 4), signal=signal, weight=0.8,
            description=desc,
        )
    ...
    def volume_trend(self, period: int = 20) -> Optional[FactorResult]:
        ...
        return FactorResult(
            ...
            value=round(ratio, 2), signal=signal, weight=0.8,
            description=desc,
        )
    ...
    def kdj(self, period: int = 9) -> Optional[FactorResult]:
        ...
        return FactorResult(
            ...
            value=round(j_val, 2), signal=signal, weight=1.0,
            description=desc,
        )
    ...
    def williams_r(self, period: int = 14) -> Optional[FactorResult]:
        ...
        return FactorResult(
            ...
            value=round(wr_val, 2), signal=signal, weight=0.8,
            description=desc,
        )
    ...
    def obv(self) -> Optional[FactorResult]:
        ...
        return FactorResult(
            ...
            value=round(slope, 2), signal=signal, weight=0.8,
            description=desc,
        )
    ...
    def cci(self, period: int = 20) -> Optional[FactorResult]:
        ...
        return FactorResult(
            ...
            value=round(cci_val, 2), signal=signal, weight=0.8,
            description=desc,
        )
    ...
    def chaikin_oscillator(self) -> Optional[FactorResult]:
        ...
        return FactorResult(
            ...
            value=round(chaikin, 2), signal=signal, weight=0.8,
            description=desc,
        )
    ...
    def atr(self, period: int = 14) -> Optional[FactorResult]:
        ...
        return FactorResult(
            ...
            value=round(atr_pct, 2), signal=signal, weight=0.5,
            description=desc,
        )
    ...
    def ma_alignment(self) -> Optional[FactorResult]:
        ...
        return FactorResult(
            ...
            value=round(score, 2), signal=signal, weight=1.5,
            description=desc,
        )
    ...
    def trend_strength(self, period: int = 14) -> Optional[FactorResult]:
        ...
        return FactorResult(
            ...
            value=round(consistency * direction, 2), signal=signal, weight=1.0,
            description=desc,
        )
    ...
    def adx(self, period: int = 14) -> Optional[FactorResult]:
        ...
        return FactorResult(
            ...
            value=round(adx_val, 2), signal=signal, weight=1.2,
            description=desc,
        )
    ...
    def dmi(self, period: int = 14) -> Optional[FactorResult]:
        ...
        return FactorResult(
            ...
            value=round(pdi_val - mdi_val, 2), signal=signal, weight=1.0,
            description=desc,
        )
    ...
    def historical_volatility(self, period: int = 20) -> Optional[FactorResult]:
        ...
        return FactorResult(
            ...
            value=round(vol, 2), signal=signal, weight=0.5,
            description=desc,
        )
    ...
    def max_drawdown_factor(self) -> Optional[FactorResult]:
        ...
        return FactorResult(
            ...
            value=round(md, 2), signal=signal, weight=0.8,
            description=desc,
        )
    ...
    def downside_volatility(self, period: int = 20) -> Optional[FactorResult]:
        ...
        return FactorResult(
            ...
            value=round(dv, 2), signal=signal, weight=0.5,
            description=desc,
        )
    ...
    def sharpe_ratio(self, period: int = 252) -> Optional[FactorResult]:
        ...
        return FactorResult(
            ...
            value=round(sharpe, 2), signal=signal, weight=0.5,
            description=desc,
        )
    ...
    def sortino_ratio(self, period: int = 252) -> Optional[FactorResult]:
        ...
        return FactorResult(
            ...
            value=round(sortino, 2), signal=signal, weight=0.5,
            description=desc,
        )
    ...
    def garman_klass_volatility(self, period: int = 20) -> Optional[FactorResult]:
        ...
        return FactorResult(
            ...
            value=round(v, 2), signal=signal, weight=0.5,
            description=desc,
        )
    ...
    def skewness_factor(self, period: int = 20) -> Optional[FactorResult]:
        ...
        return FactorResult(
            ...
            value=round(skew, 2), signal=signal, weight=0.5,
            description=desc,
        )
    ...
    def kurtosis_factor(self, period: int = 20) -> Optional[FactorResult]:
        ...
        return FactorResult(
            ...
            value=round(kurt, 2), signal=signal, weight=0.5,
            description=desc,
        )
    ...
    def amihud_illiquidity(self, period: int = 20) -> Optional[FactorResult]:
        ...
        return FactorResult(
            ...
            value=round(v, 4), signal=signal, weight=0.5,
            description=desc,
        )
    ...
    def weekly_reversal(self) -> Optional[FactorResult]:
        ...
        return FactorResult(
            ...
            value=round(ret, 2), signal=signal, weight=0.8,
            description=desc,
        )
    ...
    def gap_factor(self) -> Optional[FactorResult]:
        ...
        return FactorResult(
            ...
            value=round(avg_gap, 2), signal=signal, weight=0.5,
            description=desc,
        )
    ...
    def pe_factor(self) -> Optional[FactorResult]:
        ...
        return FactorResult(
            ...
            value=round(pe, 2), signal=signal, weight=1.0,
            description=desc,
        )
    ...
    def pb_factor(self) -> Optional[FactorResult]:
        ...
        return FactorResult(
            ...
            value=round(pb, 2), signal=signal, weight=1.0,
            description=desc,
        )
    ...
    def ps_factor(self) -> Optional[FactorResult]:
        ...
        return FactorResult(
            ...
            value=round(ps, 2), signal=signal, weight=0.8,
            description=desc,
        )
    ...
    def roe_factor(self) -> Optional[FactorResult]:
        ...
        return FactorResult(
            ...
            value=round(roe, 2), signal=signal, weight=1.0,
            description=desc,
        )
    ...
    def roa_factor(self) -> Optional[FactorResult]:
        ...
        return FactorResult(
            ...
            value=round(roa, 2), signal=signal, weight=0.8,
            description=desc,
        )
    ...
    def eps_growth_factor(self) -> Optional[FactorResult]:
        ...
        return FactorResult(
            ...
            value=round(g, 2), signal=signal, weight=1.0,
            description=desc,
        )
    ...
    def revenue_growth_factor(self) -> Optional[FactorResult]:
        ...
        return FactorResult(
            ...
            value=round(g, 2), signal=signal, weight=0.8,
            description=desc,
        )
    ...
    def dividend_yield_factor(self) -> Optional[FactorResult]:
        ...
        return FactorResult(
            ...
            value=round(y, 2), signal=signal, weight=0.6,
            description=desc,
        )
    ...
    def market_cap_factor(self) -> Optional[FactorResult]:
        ...
        return FactorResult(
            ...
            value=round(mcap_yi, 2), signal=signal, weight=0.5,
            description=desc,
        )
