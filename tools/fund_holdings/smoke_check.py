...
def check_get_holdings_from_filing():
...
if __name__ == "__main__":
    ...
    print()
    success &= check_parse_holdings()
    print()
    success &= check_analysis()
    print()
    success &= check_get_recent_filings()
    print()
    success &= check_get_holdings_from_filing()
